...
Alternatively to this flow you can just use the POST /applicationconnector/registration endpoint of the personservice where you insert the URL from Kyma into the JSON.
